 ...
 * under the License.
 */
package org.jclouds.vsphere.strategy;
 ...
 */
@Singleton
public class CreateNodesWithGroupInAnnotationThenAddToSet implements CreateNodesInGroupThenAddToSet {
   ...
   protected class AddNode implements Callable<AtomicReference<NodeMetadata>> {
      ...
      public AtomicReference<NodeMetadata> call() throws Exception {
         ...
         node = null; //addNodeWithGroupStrategy.createNodeWithGroupEncodedIntoName(group, name, template);
...
//   protected final CreateNodeWithGroupInAnnotation addNodeWithGroupStrategy;
   ...
   @Inject
   protected CreateNodesWithGroupInAnnotationThenAddToSet(
