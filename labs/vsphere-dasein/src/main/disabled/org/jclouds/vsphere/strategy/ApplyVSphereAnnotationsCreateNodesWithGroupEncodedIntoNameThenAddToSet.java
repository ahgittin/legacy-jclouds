 ...
 */
@Singleton
public class ApplyVSphereAnnotationsCreateNodesWithGroupEncodedIntoNameThenAddToSet extends
   ...
   @Inject
   protected ApplyVSphereAnnotationsCreateNodesWithGroupEncodedIntoNameThenAddToSet(
   ...
   public Map<?, Future<Void>> execute(String group, int count, Template template, Set<NodeMetadata> goodNodes,
      ...
      boolean keyPairExensionPresent = n.getKeyPairExtensionForZone(zone).isPresent();
